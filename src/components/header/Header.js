...
function Header() {
  ...
  return (
    <Navbar
      ...
      bg={!isHeaderOpaque ? 'black' : ''}
      variant={isHeaderOpaque ? 'dark' : 'dark'}
    >
      <Container>
        <Navbar.Brand
          onClick={() => {
        ...
        <Navbar.Collapse id="responsive-navbar-nav">
          ...
          <Nav>
            ...
            <div className='header_number'><a className='tel_number' href="tel:5554280940">Круглосуточно: +7 (000) 000-00-01</a><Link ><Icon.Telegram className="telegram_icon_header" /></Link> <p style={{color : "white"}}>входящие звонки бесплатно</p></div>
          </Nav>
        </Navbar.Collapse>
      </Container>
    </Navbar>
