...
function Main() {
    ...
    return (
        <>
            <Icon.Telegram className="telegram_icon" />
            <div className='mainFoto'>
                <div className="divText">
                    <p>ДОСТАВКА АЛКОГОЛЯ ПО МОСКВЕ
                        <br />
                        И МОСКОВСКОЙ ОБЛАСТИ
                        <br /> Круглосуточно<br /> <a className='tel_number_main'>+7 (000) 000-00-01</a>
                        <br />
                        <br />
                        <Button className="button_telegram" variant="success" >Заказать через телеграм{' '}<Icon.Telegram className="telegram_button_icon" /></Button>
